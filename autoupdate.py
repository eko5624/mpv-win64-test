...
pkgs['mpv'] = x['mpv']
for p in ['brotli', 'dav1d', 'ffnvcodec', 'freetype2', 'fribidi', 'harfbuzz', 'highway', 'lame', 'lcms2', 'libass', 'libbluray', 'libdvdcss', 'libdvdnav', 'libdvdread', 'libogg', 'libjxl', 'libplacebo', 'opus', 'shaderc', 'spirv-cross', 'vulkan']:
  pkgs['%s-dev' % p] = x[p]
for p in pkgs:
...
for t in ['libplacebo.yml', 'mpv-meson.yml', 'mpv-waf.yml', 'build-weekly.yml', 'package.yml']:
